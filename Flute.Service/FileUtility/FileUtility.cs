...
namespace Libra.Core
{
	...
	public static partial class FileUtility
	{
        ...
        // ??? I can't understand this Regual Expression right now.
		...
		{
            // Registry.LocalMachine : 包含本地计算机的配置数据。该字段读取 Windows 注册表基项 HKEY_LOCAL_MACHINE。
        ...
        /// <summary>
        /// Combine divided path elements
        /// </summary>
        /// <param name="paths"></param>
        /// <returns></returns>
        /// Commented by Jingwei.WU 2009.03.25
        ...
        /// <summary>
        /// find out the minimal common base directory shared by dir1 and dir2
        /// </summary>
...
//				erg.Append(Path.DirectorySeparatorChar);
		...
		/// <summary>
		/// Combines baseDirectoryPath with relativePath and normalizes the resulting path.
		/// </summary>
        ...
        /// <summary>
        /// Copy all files as well as sub directories frome source Dir to dest Dir. 
        /// </summary>
        /// <param name="sourceDirectory"></param>
        /// <param name="destinationDirectory"></param>
        /// <param name="overwrite">whether overwrite files in dest Dir by files of the same names</param>
        ...
        //
        // MatchsPattern --> Match --> MatchN
        // by Jingwei.WU 2009.03.25
        //
		...
		public static FileOperationResult ObservedSave(FileOperationDelegate saveFile, string fileName, FileErrorPolicy policy)
		{
			return ObservedSave(saveFile,
			                    fileName,
			                    ResourceService.GetString("Libra.Services.FileUtilityService.CantSaveFileStandardText"),
			                    policy);
		}
